...
GGally::ggpairs(data.table(assay(rfp), assay(rna)))
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#
# Translational efficiency
#¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤#

rfp2 <- countTable(df.rfp, region = "mrna", type = "fpkm", collapse = F)
rna2 <- countTable(df.rna, region = "mrna", type = "fpkm", collapse = F)
...
gg <- GGally::ggpairs(data.table(log2(rfp2 + 0.0001), log2(rna2 + 0.0001)))
ggsave("/export/valenfs/projects/uORFome/RCode1/Preeti_Riboseq/cor_plots_all_fpkm_log2.png", gg, width = 15, height = 15)
gg <- GGally::ggpairs(data.table(log2(rfp + 0.0001), log2(rna + 0.0001)))
ggsave("/export/valenfs/projects/uORFome/RCode1/Preeti_Riboseq/cor_plots_all_count_log2.png", gg, width = 15, height = 15)
